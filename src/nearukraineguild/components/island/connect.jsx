...
const Cards = [
  {
    ...
    href: "/devgovgigs.near/widget/app?page=community&handle=hacks",
  },
  {
    title: "NEAR Platform Fellowship",
    description: "Improve the NEAR dev experience with guidance & funding.",
    href: "/devgovgigs.near/widget/app?page=community&handle=fellowship",
  },
  {
    title: "Protocol",
    description: "Support the ongoing innovation of the NEAR protocol.",
    href: "/devgovgigs.near/widget/app?page=community&handle=protocol",
  },
  {
    title: "Zero Knowledge",
    description: "Build a Zero Knowledge ecosystem on NEAR.",
    href: "/devgovgigs.near/widget/app?page=community&handle=zero-knowledge",
  },
  {
    title: "Contract Standards",
    description: "Coordinate the contribution to the NEAR dapp standards.",
    href: "/devgovgigs.near/widget/app?page=community&handle=contract-standards",
  },
];
